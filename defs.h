...
double  a_Jcon[N1M][N2M][N3M][NDIM]; // added to calculate current -- GS
double  a_pa[N1M][N2M][N3M][NPR];
...
double (* Jcon)[N2M][N3M][NDIM]; // added to calculate current -- GS
double (*   pa)[N2M][N3M][NPR] ;
