...
//#define N1       (96)         /* number of physical zones in X1-direction */  //change back to 256x256
//#define N2       (192)         /* number of physical zones in X2-direction */
...
extern double  a_Jcon[N1M][N2M][N3M][NDIM]; // added to calculate current -- GS
extern double  a_pa[N1M][N2M][N3M][NPR];
...
extern double (* Jcon)[N2M][N3M][NDIM]; // added to calculate current -- GS
extern double (*   pa)[N2M][N3M][NPR];
